...
public class SampleTankDrive extends TankDrive {
    ...
    public SampleTankDrive(HardwareMap hardwareMap, Motors motorsClass) {
        ...
        DcMotorEx leftFront = motorsClass.frontLeftEx;
        DcMotorEx leftRear = motorsClass.rearLeftEx;
        DcMotorEx rightRear = motorsClass.rearRightEx;
        DcMotorEx rightFront = motorsClass.frontRightEx;
